...
using Domain.SaveTheme.Internals;
using Domain.SaveTheme.Messages;
...
namespace Domain.SaveTheme.SaveThemeHandler_Tests;
...
public sealed class HandleAsync_Tests
{
	...
	public async Task Theme_Does_Not_Belong_To_User__Returns_None_With_ThemeDoesNotBelongToUserMsg()
	{
		...
		// Assert
		result.AssertNone().AssertType<ThemeDoesNotBelongToUserMsg>();
	}
