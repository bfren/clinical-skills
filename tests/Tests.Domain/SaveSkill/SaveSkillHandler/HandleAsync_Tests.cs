...
using Domain.SaveSkill.Internals;
using Domain.SaveSkill.Messages;
...
namespace Domain.SaveSkill.SaveSkillHandler_Tests;
...
public sealed class HandleAsync_Tests
{
	...
	public async Task Skill_Does_Not_Belong_To_User__Returns_None_With_SkillDoesNotBelongToUserMsg()
	{
		...
		// Assert
		result.AssertNone().AssertType<SkillDoesNotBelongToUserMsg>();
	}
